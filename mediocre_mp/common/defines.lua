...
NDiplomacy = {
	...
	MIN_RELATIONS_TO_SUPPORT_INDEPENDENCE = -199,	-- Support Independence not possible if either country has an opinion of the other lower than this
	...
	UNCONDITIONAL_SURRENDER_MIN_MONTHS = 0,
},
...
NCountry = {
	...
	EXPLOIT_COOLDOWN_MONTHS = 180,
	
	SCORNFUL_INSULT_MULTIPLIER = 2,
 	MONTHS_FOR_MAX_MP_ALERT = 6,
	...
	GREAT_PROJECT_MANPOWER_REQUIRED_FOR_CONSTRUCTION_BOOST = 10, --use a bunch of manpower to move things on
	GREAT_PROJECT_MANPOWER_CONSTRUCTION_BOOST_AMOUNT_IN_DAYS = 0, --how far throwing men at the problem gets you
	GREAT_PROJECT_MONEY_REQUIRED_FOR_CONSTRUCTION_BOOST = 1, --use a bunch of money to move things on
	GREAT_PROJECT_MONEY_CONSTRUCTION_BOOST_AMOUNT_IN_DAYS = 0, --how far throwing cash at the problem gets you
	...
	PROMOTE_INVESTMENTS_INFLATION = 0.1,
...
NEconomy = {
	...
	TRADE_ADDED_VALUE_MODIFER = 0.00,
	...
	TRADE_COMPANY_STRONG_LIMIT = 0.66,
...
NMilitary = {
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.64,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
	...
	MERCENARY_COMPANY_ARMY_TRADITION = 30.0,		-- At what army tradition mercenaries leaders are generated on.
